...
#### SMBclient - Connecting to the Share
        ...
        shellsession
`LordGreb@htb[/htb]$ smbclient -N -L //10.129.14.128         Sharename       Type      Comment        ---------       ----      -------        print$          Disk      Printer Drivers        home            Disk      INFREIGHT Samba        dev             Disk      DEVenv        notes           Disk      CheckIT        IPC$            IPC       IPC Service (DEVSM) SMB1 disabled -- no workgroup available`
...
#### RPCclient
        ...
        shellsession
`LordGreb@htb[/htb]$ rpcclient -U "" 10.129.14.128 Enter WORKGROUP\'s password: rpcclient $>`
