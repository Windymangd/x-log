...
![Certificate validity from May 18, 2021, to April 6, 2022, with DNS names: inlanefreight.htb, www.inlanefreight.htb, support.inlanefreight.htb.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/112/DomInfo-1.png)
...
#### Company Hosted Servers
        ...
        shellsession
`LordGreb@htb[/htb]$ for i in $(cat subdomainlist);do host $i | grep "has address" | grep inlanefreight.com | cut -d" " -f1,4;done blog.inlanefreight.com 10.129.24.93 inlanefreight.com 10.129.27.33 matomo.inlanefreight.com 10.129.127.22 www.inlanefreight.com 10.129.127.33 s3-website-us-west-2.amazonaws.com 10.129.95.250`
